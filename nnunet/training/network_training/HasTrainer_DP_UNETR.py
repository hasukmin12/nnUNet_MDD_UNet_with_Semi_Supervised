...
from nnunet.network_architecture.UNETR import get_default_network_config
from nnunet.network_architecture.UNETR_DP import UNETR_DP
...
class HasTrainer_DP_UNETR(nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=4, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_UNETR, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
    ...
    def initialize_network(self):
        ...
        # x : (1,1,192,176,32)
        self.network = UNETR_DP(self.num_input_channels, self.num_classes, cfg,
                                img_size=(192,176,32),
                                feature_size=16,
                                hidden_size=768,
                                mlp_dim=3072,
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        ds = self.network.encoder_decoder.deep_supervision
        self.network.encoder_decoder.deep_supervision = False
        ...
        self.network.encoder_decoder.deep_supervision = ds
        return ret
    ...
    def run_training(self):
        ...
        ds = self.network.encoder_decoder.deep_supervision
        self.network.encoder_decoder.deep_supervision = True
...
nnUNetTrainerV2_ResencUNet_copy1 = HasTrainer_DP_UNETR
nnUNetTrainerV2_ResencUNet_copy2 = HasTrainer_DP_UNETR
nnUNetTrainerV2_ResencUNet_copy3 = HasTrainer_DP_UNETR
nnUNetTrainerV2_ResencUNet_copy4 = HasTrainer_DP_UNETR
