...
from nnunet.network_architecture.CA_MDD_UNet_DP import CA_MDD_UNet_DP
...
class HasTrainer_DP_CA_MDD(nnUNetTrainerV2_DA3): #nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=4, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_CA_MDD, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
    ...
    def initialize_network(self):
        ...
        self.network = CA_MDD_UNet_DP(self.num_input_channels, self.base_num_features, blocks_per_stage_encoder, 2,
...
nnUNetTrainerV2_ResencUNet_copy1 = HasTrainer_DP_CA_MDD
nnUNetTrainerV2_ResencUNet_copy2 = HasTrainer_DP_CA_MDD
nnUNetTrainerV2_ResencUNet_copy3 = HasTrainer_DP_CA_MDD
nnUNetTrainerV2_ResencUNet_copy4 = HasTrainer_DP_CA_MDD
