...
from nnunet.network_architecture.generic_Att_block_UNet_DP import ATT_DenseUNet_DP
...
class HasTrainer_DP_Att_block(nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=4, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_Att_block, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
...
nnUNetTrainerV2_ResencUNet_copy1 = HasTrainer_DP_Att_block
nnUNetTrainerV2_ResencUNet_copy2 = HasTrainer_DP_Att_block
nnUNetTrainerV2_ResencUNet_copy3 = HasTrainer_DP_Att_block
nnUNetTrainerV2_ResencUNet_copy4 = HasTrainer_DP_Att_block
