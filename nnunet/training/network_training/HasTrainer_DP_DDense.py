...
from nnunet.network_architecture.DDense_UNet import get_default_network_config
from nnunet.network_architecture.DDense_UNet_DP import D_DenseUNet_DP

from nnunet.network_architecture.initialization import InitWeights_He
from nnunet.training.network_training.nnUNetTrainer import nnUNetTrainer
from nnunet.training.network_training.nnUNetTrainerV2 import nnUNetTrainerV2
from nnunet.training.network_training.nnUNet_variants.data_augmentation.nnUNetTrainerV2_DA3 import nnUNetTrainerV2_DA3

from nnunet.utilities.nd_softmax import softmax_helper

class HasTrainer_DP_D_dense(nnUNetTrainerV2_DA3): #nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=4, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_D_dense, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
    ...
    def initialize_network(self):
        ...
        self.network = D_DenseUNet_DP(self.num_input_channels, self.base_num_features, blocks_per_stage_encoder, 2,
...
nnUNetTrainerV2_ResencUNet_copy1 = HasTrainer_DP_D_dense
nnUNetTrainerV2_ResencUNet_copy2 = HasTrainer_DP_D_dense
nnUNetTrainerV2_ResencUNet_copy3 = HasTrainer_DP_D_dense
nnUNetTrainerV2_ResencUNet_copy4 = HasTrainer_DP_D_dense
