...
if __name__ == "__main__":
    ...
    base = "/data/sukmin/_has_Task100_Bladder_reverse"
    ...
    json_dict = {}
    json_dict['name'] = "Bladder"
    json_dict['description'] = "Bladder segmentation"
    json_dict['tensorImageSize'] = "4D"
    json_dict['reference'] = "Bladder data for nnunet"
    json_dict['licence'] = ""
