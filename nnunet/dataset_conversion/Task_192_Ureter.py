...
if __name__ == "__main__":
    ...
    base = "/data2/sukmin/_has_Task192_Ureter"

    task_id = 192
    task_name = "Ureter"
    foldername = "Task%03.0d_%s" % (task_id, task_name)

    nnUNet_raw_data = '/data2/sukmin/nnUNet_raw_data_base/nnUNet_raw_data'
    ...
    train_patients = all_cases[:160] + all_cases[182:310]
    test_patients = all_cases[160:182] + all_cases[310:]
