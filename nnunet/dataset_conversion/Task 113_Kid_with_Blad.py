...
if __name__ == "__main__":
    ...
    base = "/data/sukmin/_has_Task113_Kid_with_Blad"

    task_id = 113
    task_name = "Kid_with_Blad"

    foldername = "Task%03.0d_%s" % (task_id, task_name)

    nnUNet_raw_data = '/data/sukmin/nnUNet_raw_data_base/nnUNet_raw_data'
    ...
    train_patients = all_cases[:150] + all_cases[300:400] + all_cases[600:700]
    test_patients = all_cases[150:209] + all_cases[700:] + all_cases[400:540]
    ...
    json_dict = {}
    json_dict['name'] = "Kidney_Bladder"
    json_dict['description'] = "Kidney_Bladder segmentation"
    json_dict['tensorImageSize'] = "4D"
    json_dict['reference'] = "Kidney_Bladder data for nnunet"
    json_dict['licence'] = ""
