...
import numpy as np
import torch
from nnunet.network_architecture.custom_modules.conv_block_for_Double_Dense_plus import DenseDownLayer_2, DenseDownBlock_2, DenseUpBlock, DenseUpLayer , DenseDownLayer_first, DenseDownBlock_first, DenseDownLayer_3, DenseDownLayer_4
...
class DenseUNetEncoder(nn.Module):
    def __init__(self, input_channels, base_num_features, num_blocks_per_stage, feat_map_mul_on_downscale,
        ...
        self.DenseDownLayer = []
        self.DenseDownLayer.append(DenseDownLayer_2)
        self.DenseDownLayer.append(DenseDownLayer_3)
        self.DenseDownLayer.append(DenseDownLayer_4)
        self.DenseDownLayer.append(DenseDownLayer_4)
        ...
        for stage in range(num_stages):
            ...
            current_stage =  self.DenseDownLayer[stage](current_output_features, current_output_features, current_kernel_size,
...
class D_DenseUNet_plus(SegmentationNetwork):
    """
    Residual Encoder, Plain conv decoder
    """
    use_this_for_2D_configuration = 1244233721.0  # 1167982592.0
...
def find_3d_configuration():
    ...
    blocks_per_stage_encoder = D_DenseUNet_plus.default_blocks_per_stage_encoder
    blocks_per_stage_decoder = D_DenseUNet_plus.default_blocks_per_stage_decoder
    ...
    unet = D_DenseUNet_plus(num_modalities, initial_num_features, blocks_per_stage_encoder[:len(conv_op_kernel_sizes)], 2,
    ...
    print(D_DenseUNet_plus.compute_approx_vram_consumption(patch_size, initial_num_features, max_num_features, num_modalities,
                                                num_classes, pool_op_kernel_sizes,
