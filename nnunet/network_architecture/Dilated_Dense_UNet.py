...
import numpy as np
import torch
from nnunet.network_architecture.custom_modules.conv_block_for_Dilated_dense import DenseDownLayer_2, DenseDownBlock_2, DenseUpBlock, DenseUpLayer , DenseDownLayer_first, DenseDownBlock_first
...
class Dilated_DenseUNet(SegmentationNetwork):
    """
    Residual Encoder, Plain conv decoder
    """
    use_this_for_2D_configuration = 1244233721.0  # 1167982592.0
...
def find_3d_configuration():
    ...
    blocks_per_stage_encoder = Dilated_DenseUNet.default_blocks_per_stage_encoder
    blocks_per_stage_decoder = Dilated_DenseUNet.default_blocks_per_stage_decoder
    ...
    unet = Dilated_DenseUNet(num_modalities, initial_num_features, blocks_per_stage_encoder[:len(conv_op_kernel_sizes)], 2,
    ...
    print(Dilated_DenseUNet.compute_approx_vram_consumption(patch_size, initial_num_features, max_num_features, num_modalities,
                                                num_classes, pool_op_kernel_sizes,
