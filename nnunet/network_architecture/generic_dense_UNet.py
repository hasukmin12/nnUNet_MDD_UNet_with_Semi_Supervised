...
import numpy as np
import torch
from nnunet.network_architecture.custom_modules.conv_blocks import DenseDownLayer, DenseDownBlock, DenseUpBlock, DenseUpLayer #, DenseDownLayer_first, DenseDownBlock_first
...
class DenseUNetEncoder(nn.Module):
    def __init__(self, input_channels, base_num_features, num_blocks_per_stage, feat_map_mul_on_downscale,
        ...
        for stage in range(num_stages):
            ...
            current_stage = DenseDownLayer(current_output_features, current_output_features, current_kernel_size, props,
