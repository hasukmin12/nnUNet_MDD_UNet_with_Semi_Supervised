...
class ICConv3d(nn.Module):
    def __init__(self, inplanes, planes, kernel_size, padding, props, stride=1, bias=False):
        ...
        # self.conv_2 = nn.Conv3d(inplanes, planes, kernel_size=kernel_size,padding=2, bias=bias, dilation=2)
        # self.conv_3 = nn.Conv3d(inplanes, planes, kernel_size=kernel_size,padding=3, bias=bias,  dilation=3)
    ...
    def forward(self, x):
        ...
        # out_2 = self.nonlin(self.norm(self.conv_2(x)))
        # out_3 = self.nonlin(self.norm(self.conv_3(x)))
...
#
# class ICConv3d(nn.Module):
#     def __init__(self, inplanes, planes, kernel_size, padding, stride=1, groups=1, bias=False):
#         super(ICConv3d, self).__init__()
#         self.conv_list = nn.ModuleList()
#         self.planes = planes
#         self.conv_list.append(nn.Conv3d(inplanes, planes, kernel_size=kernel_size,
#                                                 padding=padding, bias=bias, groups=groups, dilation=1))
#         self.conv_list.append(nn.Conv3d(inplanes, planes, kernel_size=kernel_size,
#                                         padding=padding, bias=bias, groups=groups, dilation=2))
#         self.conv_list.append(nn.Conv3d(inplanes, planes, kernel_size=kernel_size,
#                                         padding=padding, bias=bias, groups=groups, dilation=3))
#         self.conv_1 = nn.Conv3d(planes*3, planes, kernel_size=[1 for _ in kernel_size],
#                                       padding=[0 for i in kernel_size])
#
#     def forward(self, x):
#         out = []
