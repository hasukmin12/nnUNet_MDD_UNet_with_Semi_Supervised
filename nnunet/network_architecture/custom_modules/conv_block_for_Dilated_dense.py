...
class DenseDownBlock_first(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, props, stride=None):
        ...
        # small version
        self.conv1 = nn.Conv3d(in_planes, in_planes, kernel_size=kernel_size,  padding=3, dilation=3)
        ...
        self.conv2 = nn.Conv3d(in_planes*2, in_planes, kernel_size=kernel_size,  padding=3, dilation=3)
...
class DenseDownBlock_2(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, props, stride=None):
        ...
        #                               padding=[(i - 1) // 2 for i in kernel_size],
        #                               **kwargs_conv1)
        self.conv1 = nn.Conv3d(in_planes, in_planes, kernel_size=kernel_size,
        ...
        #                               padding=[(i - 1) // 2 for i in kernel_size],
        #                               **props['conv_op_kwargs'])
        self.conv2 = nn.Conv3d(in_planes*2, in_planes*2, kernel_size=kernel_size,
                               padding=3, dilation=3)
...
class DenseUpBlock(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, props, stride=None):
        ...
        self.conv1 = nn.Conv3d(aim_planes, aim_planes, kernel_size=kernel_size,
                               padding=3, dilation=3)
        ...
        self.conv2 = nn.Conv3d(aim_planes*2, aim_planes, kernel_size=kernel_size,
                               padding=3, dilation=3)
